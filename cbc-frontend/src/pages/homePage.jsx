export default function HomePage() {
    ...
    return (
        <div className="bg-teal-300 w-full flex justify-center min-h-screen items-center">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-sm ">
                ...
                <a href="/admin" className="mt-4 inline-block text-blue-500 hover:text-blue-700">Admin page</a><br/>
                 <a href="/test" className="mt-4 inline-block text-blue-500 hover:text-blue-700">Test page</a>
